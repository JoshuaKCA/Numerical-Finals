...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry_function = customtkinter.CTkEntry(self, placeholder_text="Value of function", font=("Arial", 15))
    ...
    def get_input(self):
        ...
        func_val = self.entry_function.get()
        iterations = self.entry_iterations.get()
        print(f"x1: {x1}, x0: {x0}, function: {func_val}, iterations: {iterations}")
